...
rate = 1.0e-3
act = 'relu'
input_img = Input(shape=(num_time,1,22))

x = Conv2D(25, (10,1),activation=act, padding='same',kernel_regularizer=regularizers.l1(rate))(input_img)
x = Conv2D(25, (10,1),activation=act, padding='same',kernel_regularizer=regularizers.l1(rate))(x)
x = MaxPooling2D((3,1),padding='same')(x)
x = BatchNormalization()(x)
x = Dropout(0.5)(x)

x = Conv2D(50, (10,1),activation=act, padding='same',kernel_regularizer=regularizers.l1(rate))(x)
x = Conv2D(50, (10,1),activation=act, padding='same',kernel_regularizer=regularizers.l1(rate))(x)
x = MaxPooling2D((3,1),padding='same')(x)
x = BatchNormalization()(x)
x = Dropout(0.5)(x)

x = Conv2D(100, (10,1),activation=act, padding='same',kernel_regularizer=regularizers.l1(rate))(x)
x = Conv2D(100, (10,1),activation=act, padding='same',kernel_regularizer=regularizers.l1(rate))(x)
x = MaxPooling2D((3,1),padding='same')(x)
x = BatchNormalization()(x)
x = Dropout(0.5)(x)

x = Conv2D(200, (10,1),activation=act, padding='same',kernel_regularizer=regularizers.l1(rate))(x)
x = Conv2D(200, (10,1),activation=act, padding='same',kernel_regularizer=regularizers.l1(rate))(x)
x = MaxPooling2D((3,1),padding='same')(x)
x = BatchNormalization()(x)
x = Dropout(0.5)(x)
...
model_cb = ModelCheckpoint('../model_box/cnn_nt1000_cv5.hdf5', monitor='val_loss',save_best_only=True,verbose=1) 
#########################################################################################
###############################Early Stopping############################################
...
df_results.to_csv(path_or_buf='../history_box/cnn_nt1000_cv5.csv',index=False)
