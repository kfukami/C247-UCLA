...
model_cb = ModelCheckpoint('../model_box/lstm_nt200_cv5.hdf5', monitor='val_loss',save_best_only=True,verbose=1) 
#########################################################################################
###############################Early Stopping############################################
...
df_results.to_csv(path_or_buf='../history_box/lstm_nt200_cv5.csv',index=False)
