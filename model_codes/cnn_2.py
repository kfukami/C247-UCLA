...
model_cb = ModelCheckpoint('../model_box/cnn_nt1000_cv4.hdf5', monitor='val_loss',save_best_only=True,verbose=1) 
#########################################################################################
###############################Early Stopping############################################
...
df_results.to_csv(path_or_buf='../history_box/cnn_nt1000_cv4.csv',index=False)
